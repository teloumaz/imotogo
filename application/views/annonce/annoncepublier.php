                      ...
                      <div class="modal-dialog  modal-lg" role="document">
                        <div class="modal-content">
                          <div class="modal-header" >
                            <h1>FICHE TECHNIQUE DE VENTE/LOCATION D'UN IMMOBILIER SUR IMOTOGO</h1>
                          </div>
                ...
                <div class="table-responsive" style="width:100%;height: 500px;">
                   <table style="margin-top: 10px;">
                    ...
                    foreach ($result as $row) {?>
                      ...
                      <?php
                      if ($td%2!=0) {
                         echo '<tr><td style="width:50%;"><div class="row"><div class="col-sm-4"><img src="'.base_url('assets/apercues_imo/').$row->apercu1.'" style="width:100%;height:135px;border-radius:2px;"></div> <div class="col-sm-8">'.'<span style="font-size:13px;">Mode offre:  </span><span style="font-weight:bold;font-size:13px;color:red;">'.$row->imo_modeofre.'</span><br>'.'<span style="font-size:13px;">Prix:  </span><span style="font-weight:bold;font-size:13px;color:red;">'.$row->imo_prixvente.' FCFA</span><br><span style="font-size:13px;">Localisation:  </span><span style="font-size:13px;font-weight:bold;">'.$row->localisation.'<div><br><a class="details btn btn-primary btn-xs"  id="'.$row->annonce_id.'" style="color:white;" data-target="#pageloader1" data-toggle="modal">Plus de détails</a></div></div>   </td>';
                         ?>

                         <?php
                       } 
                       else{
                        echo '<td style="width:50%;padding-left:20px;"><div class="row"><div class="col-sm-4"><img src="'.base_url('assets/apercues_imo/').$row->apercu1.'" style="width:100%;height:125px;border-radius:2px;"></div> <div class="col-sm-8">'.'<span style="font-size:13px;">Mode offre:  </span><span style="font-weight:bold;font-size:13px;color:red;">'.$row->imo_modeofre.'</span><br>'.'<span style="font-size:13px;">Prix:  </span><span style="font-weight:bold;font-size:13px;color:red;">'.$row->imo_prixvente.' FCFA</span><br><span style="font-size:13px;">Localisation:  </span><span style="font-weight:bold;font-size:13px;">'.$row->localisation.' <div><br><a class="details btn btn-primary btn-xs" id="'.$row->annonce_id.'" style="color:white;" data-target="#pageloader1" data-toggle="modal"  >Plus de détails</a> </div></div></div>  </td> <tr style="height:30px;"></tr>';
                       }
                       $td++;
                    }
                    ?> 
