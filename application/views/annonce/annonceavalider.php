            ...
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-header bg-primary" style="color: white;text-align: center;font-weight: bold;">
                    LES ANNONCES EN COURS DE VALIDATION
                </div>
                <div class="table-responsive">
                  <table class="table  table-sm">
                    <thead>
                      <th style="background-color: silver;font-weight:bold;">Annonceur</th>
                      <th style="background-color: silver;font-weight:bold;">Categorie Imo</th>
                      <th style="background-color: silver;font-weight:bold;">Localisation</th>
                      <th style="background-color: silver;font-weight:bold;">Superficie</th>
                      <th style="background-color: silver;font-weight:bold;">Type d'offre</th>
                      <th style="background-color: silver;font-weight:bold;">Apercu</th>
                      <th width="50px" style="background-color: silver;font-weight:bold;">Actions</th>
                    </thead>
                    <tbody>
                      <?php
                      foreach ($result as $row){
                        echo '<tr><td>'.$row->annonceur.'</td><td>'.$row->categorie.'</td><td>'.$row->localisation.'</td><td>'.$row->imo_superficie.'</td><td>'.$row->imo_modeofre.'</td><td><img src="'.base_url('assets/apercues_imo/').$row->apercu1.'"></td><td><a class="btn btn-xs btn-dark btn-rounded" style="color:white;" href="'.site_url('annonce/annonce/validerannonce').'?id='.$row->imo_ref.'"><i class="mdi mdi-check-all"></i> </a></td></tr>';
                      }
                    ?>
                    </tbody>
