                ...
                <div class="table-responsive">
                  <table class="table  table-sm">
                    <thead>
                      ...
                      <th style="background-color: silver;font-weight:bold;">Description</th>
                      <th style="background-color: silver;font-weight:bold;">Etat</th>
                    </thead>
                    <tbody>
                      <?php
                      foreach ($result as $row){
                        if($row->annonce_statut==1){$etatannonce='En validation';}
                       if($row->annonce_statut==2){$etatannonce='Validé';}

                        echo '<tr><td>'.$row->categorie.'</td><td>'.$row->localisation.'</td><td>'.$row->imo_superficie.'</td><td>'.$row->imo_modeofre.'</td><td>'.$row->annonce_descrip.'</td><td><span class="bg-warning">'.$etatannonce.'</span></td></tr>';
                      }
                    ?>
                    </tbody>
