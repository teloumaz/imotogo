  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      <!-- partial:partials/_sidebar.html -->
        ...
        <!-- partial:partials/_sidebar.html -->
     <?php $this->load->view('menuparticulier.php'); ?>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-6 grid-margin">
              <div class="card">
                <div class="card-header bg-danger" style="color:white;"><h3>PUBLIER GRATUITEMENT DES ANNONCES</h3></div>
                <div class="card-body">
                  <h2>Créez votre première annonce et faites de bonnes affaires !</h2>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 grid-margin">
              <div class="card">
                <div class="card-header bg-danger" style="color:white;"><h3>EFFECTUEZ UNE DEMANDE DE VISITE D'UN BIEN</h3></div>
                <div class="card-body">
                   <h3>Contactez directement l'agence démarcheur du bien qui vous intérresse</h3>
                </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card">
                <div class="card-header bg-primary" style="color:white;background: linear-gradient(100deg,#3d7131,#3d7131) !important;"><h4>LES PUBLICATIONS RECENTES</h4>
                </div>
                <div class="">
                ...
                <div class="card-footer bg-primary" style="background: linear-gradient(100deg,#3d7131,#3d7131) !important;"></div>
