            ...
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-header bg-primary" style="color: white;text-align: center;font-weight: bold;">
                    LES VISITES EN COURS DE VALIDATION
                </div>
                <div class="table-responsive">
                  <table class="table  table-sm">
                    <thead>
                      <th style="background-color: silver;font-weight:bold;">Demandeur</th>
                      <th style="background-color: silver;font-weight:bold;">Bien à visiter</th>
                      <th style="background-color: silver;font-weight:bold;">Mode Paiement</th>
                      <th width="50px" style="background-color: silver;font-weight:bold;">Actions</th>
                    </thead>
                    <tbody>
                     <!--  <?php
                      foreach ($result as $row){
                        echo '<tr><td>'.$row->annonceur.'</td><td>'.$row->categorie.'</td><td>'.$row->localisation.'</td><td><a class="btn btn-xs btn-dark btn-rounded" style="color:white;" href="'.site_url('annonce/annonce/validerannonce').'?id='.$row->imo_ref.'"><i class="mdi mdi-check-all"></i> </a></td></tr>';
                      }
                    ?> -->
                    </tbody>
